...
public class Excel2007Utils {
    ...
    public static void main(String[] args) throws ReportInternalException, IOException {
        ...
        writeExcelTitle("F:\\temp","a",sheetTitle,columnNames,sheetName,false);

        List<List<Object>> objects = Lists.newArrayList();
        for(int i=0;i<1000;i++){
            List<Object> dataList = Lists.newArrayList();
            dataList.add("2016-09-05 17:27:25");
            dataList.add(new Date());
            dataList.add(1450000144454L);
            dataList.add("000628");
            dataList.add(i);
            dataList.add(1.323+i);
            objects.add(dataList);
        }
        writeExcel("F:\\temp","b",sheetName,columnNames,sheetTitle,objects,false);
    }
}
